...
export const SCENES: CanopyScene[] = [
  { bg: '#e8c8c8', hero: 'Cada centavo público, com fonte',    mockup: 'prompt', promptText: 'Emendas do deputado X em saúde, 2023-2024', hold: HOLD },
  { bg: '#f3ecdc', hero: 'Da emenda ao boleto, auditável',   mockup: 'prompt', promptText: 'Compare execução do PT com PL em educação', hold: HOLD },
